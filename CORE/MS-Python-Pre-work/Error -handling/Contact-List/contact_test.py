...
class Testcontact(unittest.TestCase):
    ...
    def test_delete_contact(self):
        '''
        test_delete_contact to est if we can delete a contact from our contact list
        '''
        self.new_contact.save_contact()
        test_contact = Contact("Test","user","0712345678","test@user.com")#new contact
        test_contact.save_contact()
    ...
    def test_find_contact_by_number(self):
        '''
        test to check f we can find a contact and display information
        '''
        self.new_contact.save_contact()
    ...
    def test_copy_email(self):
        '''
        Test to confirm we are actually copying the amail address found from a contact
        '''
